"""Router đơn hàng: tra cứu theo id và tạo đơn mới; lỗi nghiệp vụ từ create_order được map sang mã HTTP phù hợp."""
...
def create_order(payload: CreateOrderRequest):
    try:
        ...
        # "not found" -> 404 (sai product_id), còn lại (vd hết hàng) -> 400.
        message = str(exc)
